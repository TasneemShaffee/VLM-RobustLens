        ...
        if mm_token_type_ids is not None:
            ...
            if isinstance(slices, dict):
                for key, mat in slices.items():
                    ...
                    kind = {"TT":"text↔text","VV":"vision↔vision","TV":"text→vision","VT":"vision→text"}[key]
...
def package_attention_run(vision_attn_weights, text_attn_weights, mm_token_type_ids=None, avg_heads=True):
    """
