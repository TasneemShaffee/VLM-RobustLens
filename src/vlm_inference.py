    ...
    def __init__(
        ...
        *,
        ...
        if enable_attn:
            ...
            if getattr(self.cfg, "attn_implementation", None) in (
                None,
                "sdpa",
                "flash_attention_2",
            ):
                self.cfg.attn_implementation = "eager"
            if hasattr(self.cfg, "output_attentions"):
                self.cfg.output_attentions = True
            if hasattr(self.cfg, "use_cache"):
...
class InternVLRunner(VLMRunner):
    ...
    def _pack_inputs(self, images, text) -> Dict[str, Any]:
        ...
        pixel_values = torch.cat(all_tile_tensors, dim=0).to(
